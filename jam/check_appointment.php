                    ...
                    <table class="table table-striped table-striped-columns table-hover table-sm">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>2022-23-23</td>
                                <td>12:00am</td>
                                <td class="d-lg-flex justify-content-lg-center"><button class="btn btn-primary btn-sm" type="button" style="background: #2ecc71;border-style: none;">Update</button><input type="checkbox" style="margin-left: 20px;"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
