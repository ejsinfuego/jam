                                ...
                                <div class="col-md-8 col-lg-11 col-xl-5 col-xxl-6">
                                    <div class="card mb-5">
                                        <div class="card-body p-sm-5" style="font-family: Alexandria, sans-serif;box-shadow: 3px 3px var(--bs-primary-border-subtle);border-radius: 6px;">
                                            ...
                                            <form method="post">
                                                <p style="color:#6c757d;"><?php echo "Current Scheduled Date: ".date('M-Y-d', strtotime($editAppointment['appointmentDate'])); ?></p>
                                                <div class="mb-3">
                                                <label class="form-label">New Date</label>
                                                <input class="form-control mb-4" id="name-2" name="date" placeholder="<?php echo $editAppointment['appointmentDate']; ?>" type="date">
                                                <p style="color:#6c757d;"><?php echo "Current Scheduled Date: ".date('h:i a', strtotime($editAppointment['appointmentTime'])); ?></p>
                                                <label class="form-label"> New Time</label>
                                                <input class="form-control" id="name-1" name="time" placeholder="<?php echo $appointmentDate['appointmentTime']; ?>" value="<?php echo $appointmentDate['appointmentTime']; ?>" type="time">
                                                </div>
                                                <label class="form-label">Type</label>
                                                <div class="dropdown bg-light-subtle d-flex justify-content-xxl-start" style="width: auto;">
                                                    <select class="btn dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" type="button" name="service_id"></button>
                                                    <div class="dropdown-menu">
                                                        <?php foreach($services as $availableServices) : ?>
                                                        <option class="dropdown-item" value="<?php echo $availableServices['id']; ?>">
                                                        <?php echo $availableServices['service']; ?></option>
                                                    <?php endforeach; ?>
                                                    </div>
                                                    </select>
                                                </div>
