...
if(isset($_POST)){
    ...
    $cancel = $database->query('update appointments set cancel_details="'.$yes.'" where id='.$_SESSION['appointment_id']);
                                ...
                                <div class="col-md-8 col-lg-11 col-xl-5 col-xxl-6">
                                    <div class="card mb-5">
                                        <div class="card-body p-sm-5" style="font-family: Alexandria, sans-serif;box-shadow: 3px 3px var(--bs-primary-border-subtle);border-radius: 6px;">
                                            <h2 class="text-center mb-4" style="color: #6c757d;">Cancellation</h2>
                                            <h6 class="text-center mb-4" style="font-family: Alexandria, sans-serif;color: #6c757d;margin: -19px;">You are about to cancel an appointment.</h6>
                                            <form method="post">
                                                <div class="mb-3"><label class="form-label">Service :</label>
                                                <p><?php echo $appointments['service'] ?></p>
                                                <label class="form-label" style="padding-top: 0px;margin-top: 8px;">Date :</label>
                                                <p><?php echo date('M d, Y', strtotime($appointments['appointmentDate'])); ?></p>
                                                <label class="form-label">Time :</label>
                                                <p><?php echo date('h:i a', strtotime($appointments['appointmentTime'])); ?></p>
                                                <div class="mb-3"></div>
                                                <div><button class="btn btn-danger d-block w-100" type="submit">Cancel</button></div>
                                            </form>
                                        </div>
                                    </div>
                                </div>
