                        ...
                        <?php foreach($services as $availableServices) : ?>
                            <div class="col">
                                <div class="card">
                                    ...
                                    <div class="card-footer p-4 py-3"><a href="calendar.php" style="font-family: Alexandria, sans-serif;color: var(--bs-secondary);">Book an Appointment&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-arrow-right">
