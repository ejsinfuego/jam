...
<section  class="d-flex flex-wrap">
    ...
    <?php endforeach; ?>
    <div class="addEvent">
                    <div class=""><svg class="p-5" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="var(--bs-primary-border-subtle)" viewBox="0 0 16 16" class="bi bi-plus-lg" style="font-size: 250px;">
